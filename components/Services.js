    ...
    >
      ...
      <div
        style={{
          ...
          height: "60%",
          background:
            "radial-gradient(ellipse, rgba(200,169,110,0.04) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
        ...
        >
          ...
          <div style={{ position: "sticky", top: "120px" }}>
            ...
            >
              Services That
              <br />
              <span className="gold-text">Move Rankings</span>
            </h2>
            <p
              style={{
            ...
            >
              Every service is engineered around one outcome: sustainable
              organic growth that compounds over time and outlasts algorithm
              updates.
            </p>
            ...
            {services.map((s, i) => (
              <div
                ...
                style={{
                  ...
                  transform:
                    activeService === i ? "translateX(0)" : "translateX(0)",
                  position: "relative",
                  overflow: "hidden",
                }}
              >
