...
const filters = [
  ...
  // "APP Development",
  // "Content Writing Content Translation, Copywriting",
];
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Real clients. Real rankings. Real revenue. Every case study shows
            the exact strategy, timeline, and results achieved.
          </p>
        </div>
      </section>
            ...
            {filters.map((f) => (
              <button
                ...
                style={{
                  ...
                  color:
                    activeFilter === f ? "var(--gold)" : "var(--text-muted)",
                  padding: "20px 24px",
                  fontFamily: "DM Sans",
                  fontWeight: 600,
                  fontSize: "0.85rem",
            ...
            <div style={{ padding: "36px" }}>
              ...
              >
                <div>
                  ...
                  >
                    {selectedProject.niche} · {selectedProject.duration}
                  </div>
                  <h2
                    style={{
                      fontFamily: "Syne",
                ...
                >
                  {selectedProject.result} {selectedProject.resultLabel}
                </div>
              </div>
